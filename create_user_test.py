...
# Параметр fisrtName состоит из содержит английские буквы
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")

# Тест 6. Успешное создание пользователя
# Параметр fisrtName состоит из содержит русские буквы
...
# Тест 8. Ошибка
# Параметр fisrtName содержит спец. символы
...
# Тест 12. Ошибка
# Параметр fisrtName состоит из другого типа параметров
